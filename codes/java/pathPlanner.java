...
public class pathPlanner {
    public int[][] gridValue(){
        ...
        try {
            URL path_url = new URL("http://130.230.146.209:8000/path"); //GET request to local-PC for receiving the map of workspace
    ...
    // this method computes the dynamic path planning of the mobile robot
    // compute the optimum Policy ie. the steps of the mobile robot to reach goal point
    public String[][] optimumPolicy (int[] goalCoordinates){
        int[][]gridArray = gridValue();
        int cost = 1;
        int[][] delta = {{-1,0}, {0,-1}, {1,0}, {0,1}};
        String[] deltaName = {"U", "L", "D", "R"}; // direction of movement
    ...
    // compute the number of steps the mobile robot requires to reach the 1st goal point
