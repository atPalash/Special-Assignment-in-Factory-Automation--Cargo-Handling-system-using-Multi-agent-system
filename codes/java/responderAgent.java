...
public class responderAgent extends Agent {
    // The catalogue of capabilities of the responder (maps the capability and initial start position)
    private String capability;
    private String coordinates;
    // The GUI by means of which the user can add capabilities and start position in the catalogue
    ...
    protected void setup() {
        ...
        // Register the capability as service in the yellow pages
        ...
        // Add the behaviour serving purchase orders from initiator agents
    ...
    /**
     This is invoked by the GUI when the user adds a new capability and start position
     */
    ...
    /**
     ...
     This is the behaviour used by responder agents to serve incoming requests
     for offer from initiator agents.
     If the requested book is in the local catalogue the responder agent replies
     with a PROPOSE message specifying its start coordinates. Otherwise a REFUSE message is
     sent back.
     */
    ...
    /**
     ...
     This is the behaviour used by responder agents to serve incoming
     offer acceptances (i.e. purchase orders) from initiator agents.
     The seller agent removes the purchased capability from its catalogue
     and replies with an INFORM message to notify the initiator that the
            ...
            if (msg != null) {
                ...
                if (Objects.equals(title, capability)) {
                    ...
                    try {
                        ...
                        // the python code mobile_robotServer.py watches for change in this .txt file and starts up the mobile robot behavior
                        // when it detects a change in this file in respective format
                        ...
                        int count = 0;
                        // send appripriate reply to initiator agent e.g reached start tell initiator agent that the reponder is in place to
                    ...
                    // The requested capability has been sold to another buyer in the meanwhile .
